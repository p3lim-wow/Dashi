...
--]]
function namespace:IsAddOnEnabled(name)
...
--]]
function namespace:HookAddOn(addonName, callback)
	namespace:ArgCheck(addonName, 1, 'string')
...
namespace:RegisterEvent('ADDON_LOADED', function(self, addonName)
